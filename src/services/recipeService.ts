...
export default async function getRecipe(uid : number, ingredients : string[]) : Promise<string>{
...
function generatePrompt(ingredients : string[], basics : boolean) : string {
    const res = `I am making a meal plan and only have access to a list of ingredients${basics?" and the basics like Salt, Pepper, Water":""}. Can you give me multiple detailed recipes for dishes that uses ingredients from the following list: ${ingredients.join(", ")}. \n\n Make sure the dish includes atleast 2 servings and make sure to include the name of the dish, a detailed list of ingredients used in the recipe with amounts, detailed instructions on how to make the dish, the average number of servings, nutrition information about the dish, the estimated time to make the dish, the difficulty of the dish on a scale of 1 to 5, and any equipment needed to make the dish. \n\n Follow this JSON structure strictly
    {
        recipes: [
            {
